...
const Resume = () => {
  return (  
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <h3 className="font-poppins text-xl font-semibold">PERSONAL INFORMATION</h3>
        <hr className='border-black mb-4' /> 
        <div className='flex mb-2'></div>
        <span className='w-48 font-bold'>Tempat Lahir :</span>
        <span className='text-gray-600'>Sumut</span>
